...
`
	...
	if cfg.Review.Tools.MaxRetries == nil || *cfg.Review.Tools.MaxRetries != 2 || cfg.Review.Tools.MaxTurns == nil || *cfg.Review.Tools.MaxTurns != 14 || cfg.Review.Tools.RetryBackoff != "250ms" || cfg.Review.Tools.SymbolContext.MaxBytes != 12000 || cfg.Review.Tools.SymbolContext.MaxFiles != 700 || cfg.Review.Tools.SymbolContext.MaxParallel != 6 {
