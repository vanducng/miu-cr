...
| `--approval-note none\|on_findings\|always` | `always` | Controls approval review body text. The default approval body is short LGTM-style copy with a summary link; `none` suppresses it and `on_findings` only writes it when findings remain. |
